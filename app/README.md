...
The first slice targets JVM desktop and iOS with shared lesson behaviour and shared Compose presentation. Android and web follow after the Apple/desktop lifecycle is understood.
...
```text
composeApp/src/commonMain/composeResources/files/lessons/temporal-overdue.json
```
